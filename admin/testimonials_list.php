                ...
                <div class="table-responsive">
                    <table class="table table-striped table-bordered table-hover" id="example-table" cellspacing="0"
                        ...
                        <tbody>
                            <?php
                            include('../db_con.php');
                            $fetch_query = "SELECT * FROM testimonials ORDER BY id DESC";
                            ...
                            while ($row = mysqli_fetch_array($result))
                            {
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <?php
                                        echo date("d-m-Y h:m:s A", strtotime($row['added_date']));
                                        ?>
                                    </td>
                                    <td class="text-center">
                                        <a type="submit" class="btn btn-primary shadow btn-xs sharp me-1"
                                            href="testimonial_edit.php?user_id=<?php echo $row['id']; ?>"
                                            style="color:white;">
